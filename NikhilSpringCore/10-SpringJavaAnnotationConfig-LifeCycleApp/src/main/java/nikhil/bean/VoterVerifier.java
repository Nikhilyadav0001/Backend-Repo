...
public class VoterVerifier {
	...
	static {
		System.out.println("VoterVerifier.class file loading ...");
	}
	
	public VoterVerifier() {
		System.out.println("VoterVerifier.VoterVerifier(zero param,)");
	}
	
	//Initialization methiod
	@PostConstruct
	public void myInit() {
		...
		date = LocalDate.now();
		if (name==null || age < 0) {
			throw new IllegalArgumentException("invalid input are provided for nama and age properties");
		}	
	};
