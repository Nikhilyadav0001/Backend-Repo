...
public class PersonInfo implements Serializable{
	...
	@Id
	@TableGenerator(name ="gen",table = "id_tab" ,initialValue = 10,allocationSize =5,pkColumnName ="id_col",pkColumnValue = "id",valueColumnName ="ID_VAL" )
	@GeneratedValue(generator = "gen",strategy= GenerationType.AUTO)//identity algo::mysql
	private Integer id;
