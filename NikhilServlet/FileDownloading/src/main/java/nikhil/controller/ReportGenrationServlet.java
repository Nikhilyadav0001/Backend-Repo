...
/**
 * Servlet implementation class ReportGenrationServlet
 */
@WebServlet("/showReport")
public class ReportGenrationServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try (Connection con =ds.getConnection()){
			try(PreparedStatement pstm=con.prepareStatement(SQL_SELECT_QUERY)){
