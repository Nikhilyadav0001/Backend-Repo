 ...
 */
@WebServlet(
		description = "working with init parameters", 
		urlPatterns = { "/data" }, 
		initParams = { 
				@WebInitParam(name = "PhoneNo", value = "7777777777", description = "mobile no"), 
				@WebInitParam(name = "Email id", value = "nikhil@gmail.com", description = "userid"), 
				@WebInitParam(name = "UserName", value = "Nikhil", description = "Name of the user")
		})
